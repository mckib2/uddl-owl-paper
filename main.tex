...
\subsection{ICD Satellite systems} \label{section:ICD_satellitesystems}

\subsubsection{Passive Thermal Control System:  Venetian-blind Louvers } \label{section:Venetian_Blinds}
...
\subsubsection{Location on Satellite and Systems Interactions} \label{section:Venetian_Blinds}
...
\begin{table*}[t]
    ...
    \begin{tabular}{|p{0.25\linewidth}|p{0.25\linewidth}|}
        \hline
        \textbf{Interacting Systems} & \textbf{Primary Assignment} \\
        \hline
...
\subsubsection{System Multiplicity} \label{section:Venetian_Blinds}
...
\begin{table*}[t]
    ...
    \begin{tabular}{|p{0.25\linewidth}|p{0.25\linewidth}|}
        \hline
        \textbf{Interface} & \textbf{Exist on System} \\
        \hline
        Telemetry & \checkmark \\
        \hline
        Command & $\times$ \\
...
\subsubsection{Louver Mechanical Assembly Components and Interfaces} \label{section:Venetian_Blinds}
Louvers are made of three main components
\textbf{Structural frame} is mounted to a heat source within the satellite (internal or external),
\textbf{Louver blades} are the elements that open and close, regulating heat convection and emissivity levels of the heat source of interest.
\textbf{Bimetallic Springs} (made of two different aluminium alloys) are temperature-sensitive springs that connect the structural frame (in touch with the heat source) with the blades. They are bimetal to ensure that their bending will effectively open the blades at an angle.  The spring materials have a set point temperature between around -20 C and +50 C when the blades start to open. Then the blades go from fully closed to fully open within a 10-20 C control band [est et TO ADD REF] 





\subsubsection{Mechanical Operation and Telemetry Messages } \label{section:Venetian_Blinds}
...
\subsubsection{Power Generation System: Solar Panels} \label{section:Solar_Panels}
A Solar Panel (also known as a photovoltaic cell or solar cell) is a flat surface device that directly transforms solar radiation into electrical power. Earth-orbiting satellites from LEO (Low Earth Orbit) to GEO (Geosynchronous Orbit) are the best candidates for solar panels as their power source.
...
\textit{Location on Satellite and Systems Interactions} \label{section:Solar_Panels} \\


\textit{System Multiplicity} \label{section:Solar_Panels} \\



\textit{Solar Panels Mechanical Assembly Components and Interfaces} \label{section:Solar_Panels} \\


\textit{Mechanical Operation and Telemetry Messages } \label{section:Solar_Panels} \\
